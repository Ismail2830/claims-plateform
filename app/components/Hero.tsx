      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-6xl font-extrabold tracking-tight text-neutral-900 mb-6 leading-[1.1]">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                ...
                className="bg-neutral-900 text-white px-8 py-4 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-neutral-800 transition-all shadow-xl shadow-neutral-200"
              >
                Accès Client <ArrowRight className="w-5 h-5" />
              </button>
              <button 
                onClick={() => onStart('gestionnaire')}
                className="bg-white text-neutral-900 border border-neutral-200 px-8 py-4 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-neutral-50 transition-all"
              >
                Espace Gestionnaire
              </button>
            </div>
          ...
          >
            ...
            {/* Floating Cards */}
            <div className="absolute -bottom-6 -left-6 z-20 bg-white p-4 rounded-2xl shadow-xl border border-neutral-100 flex items-center gap-4 animate-bounce-slow">
              <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center text-green-600">
                <CheckCircle2 className="w-6 h-6" />
              </div>
              <div>
                <p className="text-xs text-neutral-500 font-medium">Statut</p>
                <p className="text-sm font-bold">Sinistre Approuvé</p>
              </div>
            </div>
            <div className="absolute -top-6 -right-6 z-20 bg-white p-4 rounded-2xl shadow-xl border border-neutral-100 animate-float">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-2 h-2 rounded-full bg-blue-600" />
                <p className="text-xs font-bold text-neutral-500 uppercase">Scoring IA</p>
              </div>
              <p className="text-lg font-black text-blue-600">98% Fiable</p>
            </div>
          </motion.div>
        </div>
      </div>
