...
const TABS: { key: TabKey; label: string; icon: React.ReactNode }[] = [
  ...
  { key: 'PENDING_RESUBMIT', label: 'À re-soumettre', icon: <AlertTriangle  className="w-3.5 h-3.5" /> },
                ...
                {missing.map(m => (
                  <div key={m.claimId} className="flex items-center gap-4 px-5 py-3">
                    <div className="shrink-0">
                      <a
                        href={`/dashboard/super-admin/claims?id=${m.claimId}`}
                    ...
                    <button
                      onClick={() => router.push(`/dashboard/super-admin/claims?id=${m.claimId}&action=notify`)}
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          {doc.claim ? (
                            <a
                              href={`/dashboard/super-admin/claims?id=${doc.claim.claimId}`}
