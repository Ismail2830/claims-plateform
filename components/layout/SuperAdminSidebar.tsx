...
import { SUPER_ADMIN_NAV, SUPER_ADMIN_NAV_BOTTOM } from '@/constants/super-admin-nav';
    ...
    <TooltipProvider delayDuration={100}>
      ...
      >
        ...
        <div className="flex items-center justify-between px-3 py-4 border-b border-gray-200 h-16">
          ...
          {collapsed && (
            <Link href="/dashboard/super-admin" className="mx-auto">
        ...
        <nav className="flex-1 overflow-y-auto py-3 space-y-1">
          {SUPER_ADMIN_NAV.map((group, groupIndex) => (
          ...
          <div className="pt-2">
            ...
            {SUPER_ADMIN_NAV_BOTTOM.items.map((item) => {
              const active = isActive(item.href);
              const Icon = item.icon;
              const navItem = (
                <Link
